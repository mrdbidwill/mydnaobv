...
class Settings(BaseSettings):
    ...
    inat_county_project_ids: str = Field(
        default="124358,184305,132913,251751",
        alias="INAT_COUNTY_PROJECT_IDS",
    )
    ...
    export_sync_max_concurrent: int = Field(default=1, alias="EXPORT_SYNC_MAX_CONCURRENT")
    ...
    export_image_cache_ttl_days: int = Field(default=14, alias="EXPORT_IMAGE_CACHE_TTL_DAYS")
    export_image_cache_retention_days: int = Field(default=45, alias="EXPORT_IMAGE_CACHE_RETENTION_DAYS")
    export_image_cache_prune_interval_hours: int = Field(default=24, alias="EXPORT_IMAGE_CACHE_PRUNE_INTERVAL_HOURS")
    export_image_cache_max_prune_files: int = Field(default=500, alias="EXPORT_IMAGE_CACHE_MAX_PRUNE_FILES")
    ...
    public_refresh_interval_days: int = Field(default=14, alias="PUBLIC_REFRESH_INTERVAL_DAYS")
    ...
    catalog_sync_max_pages: int = Field(default=2000, alias="CATALOG_SYNC_MAX_PAGES")
