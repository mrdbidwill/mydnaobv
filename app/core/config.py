...
class Settings(BaseSettings):
    ...
    export_retention_hours: int = Field(default=168, alias="EXPORT_RETENTION_HOURS")
    ...
    export_max_photos_per_observation: int = Field(default=3, alias="EXPORT_MAX_PHOTOS_PER_OBSERVATION")
